...
def displaysound():
    global clicksound
    if clicksound:
        winsound .PlaySound("C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\Sounds\\click.wav", winsound.SND_FILENAME)
...
def drawgraphic():
    ...
    if win:
        winsound .PlaySound("C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\Sounds\\coin2.wav", winsound.SND_FILENAME)
        messagebox.showinfo(message="You Win")

    elif Lose:
        winsound .PlaySound("C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\Sounds\\gameover5.wav", winsound.SND_FILENAME)
...
def lift():
    ...
    winsound .PlaySound("C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\Sounds\\lose4.wav",
...
def findSpacecraft():
    ...
    if Up:
        if array[spacecraft[1]-1][spacecraft[0]] == 0 or array[spacecraft[1]-1][spacecraft[0]] == 7:
            winsound .PlaySound("SomPhors_VC1_Algorithm\\Sounds\\coin2.wav", winsound.SND_FILENAME)
            point += 5
...
def find(event):
    ...
    file = open("C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\files\\"+str(level)+".txt", "r")
    array = file.read()
    array = array.split(';')
...
def startbg():
    ...
    canvas1.create_text(515,350, text = "Quit", fill="black", font="Times 35 italic bold", tags="setting")

    # Quit
    canvas1.create_rectangle(430, 420, 610, 480, fill="white", tags="quit")
    canvas1.create_text(515, 450, text = "About", fill="black", font="Times 35 italic bold", tags="quit")
...
bg = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\start.gif") 
canvas1.create_image( 0, 0, image = bg, anchor = "nw", tags="bg1")

space = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\Cartoon_spaceship_dn.png") 
bglevel = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\level.png") 
spacecrafter1 = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\playerShip2_orange.png") 
Earth = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\Earth.png") 
bggraphic = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\spaces.gif") 
heart = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\hearts.png") 
soundOn = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\soundOn.png") 
soundOff = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\soundOff.png") 
Animy = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\robot_walk1.png") 

coin3 = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\gold_3.png") 

wall = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\stoneCenter.png") 
over = PhotoImage(file = "C:\\Users\\student\\Desktop\\SomPhors_VC1_Algorithm\\images\\over.gif") 
